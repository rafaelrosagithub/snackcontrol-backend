...
var SessionController = /** @class */ (function () {
    ...
    SessionController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, userRespository, createSesison, session;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.body, email = _a.email, password = _a.password;
                        userRespository = new UserRepository_1.default();
                        createSesison = new SessionService_1.default(userRespository);
                        return [4 /*yield*/, createSesison.execute({
                                email: email,
                                password: password,
                            })];
                    case 1:
                        session = _b.sent();
                        return [2 /*return*/, response.json(session)];
                }
            });
        });
    };
