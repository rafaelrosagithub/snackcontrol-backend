...
var UpdateOrderService = /** @class */ (function () {
    function UpdateOrderService(orderRepository) {
        this.orderRepository = orderRepository;
    }
    UpdateOrderService.prototype.execute = function (_a) {
        var id = _a.id, title = _a.title, qtd = _a.qtd, unid_medida = _a.unid_medida, lote = _a.lote, escola = _a.escola, id_stock = _a.id_stock;
        return __awaiter(this, void 0, void 0, function () {
            var order;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.orderRepository.findAById(id)];
                    case 1:
                        order = _b.sent();
                        if (!order) {
