...
var UpdateClientService = /** @class */ (function () {
    function UpdateClientService(clientRepository) {
    ...
    UpdateClientService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var client, verifyEmail;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.clientRepository.findAById(id)];
                    case 1:
                        client = _b.sent();
                        if (!client) {
                        ...
                        if (email !== client.email) {
                            ...
                            verifyEmail = this.clientRepository.findAByEmail(email);
                            if (verifyEmail) {
