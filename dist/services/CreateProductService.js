...
var CreateProductService = /** @class */ (function () {
    ...
    CreateProductService.prototype.execute = function (_a) {
        var title = _a.title, unid_medida = _a.unid_medida, product_category = _a.product_category, active = _a.active;
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.productRepository.create({
                            title: title,
